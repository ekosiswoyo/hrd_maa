                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane" id="tab1">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input id="nama" name="nama" placeholder="Masukan Nama" type="text" class="form-control"  value="{{ $pelamar->nama}}" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label for="tmp_lahir" class="control-label">Tempat Lahir</label>
                                                    <input id="tmp_lahir" name="tmp_lahir" placeholder="Masukan Tempat Lahir" type="text" class="form-control"  value="{{ $pelamar->tempat_lahir}}" readonly> 
                                                </div>

                                                <div class="form-group">
                                                    <label for="tgl_lahir" class="control-label">Tanggal Lahir</label>
                                                        <input type="text" class="form-control" name="tgl_lahir" id="tgl_lahir" data-mask="9999-99-99" placeholder="YYYY-MM-DD"  value="{{ $pelamar->tanggal_lahir}}" readonly>
                                                    
                                                </div>

                                                <div class="form-group">
                                                    <label for="tmp_lahir" class="control-label">Jenis Kelamin</label>
                                                    <input id="tmp_lahir" name="tmp_lahir" placeholder="Masukan Tempat Lahir" type="text" class="form-control"  value="{{ $pelamar->jns_kel}}" readonly> 
                                                </div>

                                                <div class="form-group">
                                                    <label for="tmp_lahir" class="control-label">Status Pernikahan</label>
                                                    <input id="tmp_lahir" name="tmp_lahir" placeholder="Masukan Tempat Lahir" type="text" class="form-control"  value="{{ $pelamar->stat_pernikahan}}" readonly> 
                                                </div>
                                               
                                               
                                                <div class="form-group" style="position: static;"><label for="alamat"  class="control-label">Alamat KTP</label>
                                                    <textarea class="form-control" id="textarea" name="alamat_ktp" placeholder="Alamat KTP" readonly>{{ $pelamar->alamat_ktp}}</textarea>
                                                </div>
                                                <div class="form-group" style="position: static;"><label for="alamat" class="control-label" readonly>Alamat Domisili</label>
                                                    <textarea class="form-control" id="textarea" name="alamat_domisili" placeholder="Alamat Domisili" readonly>{{ $pelamar->alamat_domisili}}</textarea>
                                                </div>
                                                <div class="form-group" style="position: static;"><label for="telp" class="control-label"> No Telp</label> 
                                                    <input type="text" class="form-control" onkeypress="return isNumberKey(event)"  id="telp" name="telp" placeholder="No Telp"  value="{{ $pelamar->telp}}" readonly>
                                                 </div> 
                                                 <div class="form-group" style="position: static;"><label for="hp" class="control-label" readonly>No Hp</label> 
                                                    <input type="text" class="form-control" onkeypress="return isNumberKey(event)"  id="hp" name="hp" placeholder="No HP"  value="{{ $pelamar->hp}}" readonly>
                                                 </div> 
                                                <div class="form-group" style="position: static;"><label for="tmp_lahir" class="control-label" >Pendidikan Terakhir</label>
                                                    <input type="text" class="form-control" id="pend" name="pend" placeholder="Pendidikan Terakhir" readonly  value="{{ $pelamar->pend_terakhir}}">
                                                </div>


                                                <div class="form-group" style="position: static;"><label for="tgl_lamaran" class="control-label">Tanggal Masuk Lamaran</label>
                                                    <input type="text" class="form-control" name="tgl_lamaran" id="tgl_lamaran" data-mask="9999-99-99" placeholder="YYYY-MM-DD" value="{{ $pelamar->tgl_masuk_lamaran}}" readonly>
                                                </div>
                                            ...
                                            <ul class="pager wizard">
                                                ...
                                                <li class="next">
                                                        <a href="/pengalaman/{{$pelamar->nik}}/detail" style="float:right;color: #3c8dbc !important;display:inline-block;padding:5px 14px;background-color:#fff;border:1px solid #ddd;border-radius:15px">Next</a>
