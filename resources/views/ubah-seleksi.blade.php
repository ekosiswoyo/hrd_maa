                        ...
                        <div class="panel panel-success">
                            <div class="panel-heading">
                                <h3 class="panel-title">
                                    <i class="livicon" data-name="bell" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i> Data seleksi
                                </h3>
                            ...
                            <div class="panel-body">
                                <form id="commentForm" method="post" action="/seleksi/{{$seleksi->id}}">
                                        {{csrf_field()}}
                                                                    ...
                                                                    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                                                        <div class="panel-body">
                                                                            <div class="form-group after-add-more">
                                                                                <input type="text" style="position: static;" class="form-control" id="nama" name="nama" placeholder="Nama seleksi" value="{{$seleksi->nama_tes}}">
