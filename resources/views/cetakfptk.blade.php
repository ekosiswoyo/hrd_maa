                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 margin_10 animated fadeInLeftBig">
                        ...
                        <div class="lightbluebg no-radius">
                           <a href="/printfptk"> <div class="panel-body squarebox square_boxs">
                                <div class="col-xs-12 pull-left nopadmar">
                                    <div class="row">
                                        <div class="square_box col-xs-7 text-right">
                                            <h4 style="color:#fff;">BISNIS</h3>
                         ...
                         <div class="lightbluebg no-radius">
                           <a href="/printfptknon"> <div class="panel-body squarebox square_boxs">
                                <div class="col-xs-12 pull-left nopadmar">
                                    <div class="row">
                                        <div class="square_box col-xs-7 text-right">
                                            <h4 style="color:#fff;">NON BISNIS</h3>
                                            <div class="number" id=""></div>
                                        </div>
